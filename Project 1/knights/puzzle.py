...
knowledge3 = And(
    ...
    Implication(BKnight, Or(Implication(AKnight, AKnight), Implication(AKnave, AKnave))),
    Implication(BKnave, Or(Implication(AKnight, AKnave), Implication(AKnave, AKnight))),
